...
if ( ! function_exists( 'storefront_credit' ) ) {
	...
	<div class="col-full">
		<div class="site-info">
			...
			<br /> <?php printf( esc_attr__( '%1$s designed by %2$s.', 'storefront' ), 'website', '<a href="http://www.dnduy.site" title="" rel="author">EnterLaptop</a>' ); ?>
			<?php } ?>
		</div><!-- .site-info -->
	</div>
...
if ( ! function_exists( 'storefront_site_branding' ) ) {
	...
	function storefront_site_branding() {
		...
		<div class="site-branding">
			...
			<a href="<?php echo get_home_url( $blog_id = null, $path = '', $scheme = null ) ?>"><img class="logo-img" src="<?php bloginfo( 'template_directory' ); ?>/images/logo-transparent.png"></a>
...
if ( ! function_exists( 'storefront_primary_navigation' ) ) {
	...
	function storefront_primary_navigation() {
		?>
		<div class="menu-toggle-product">
                    
                   
                    <?php sidebar_product();?>
                </div>
		<nav id="site-navigation left" class="main-navigation" role="navigation" aria-label="<?php esc_html_e( 'Primary Navigation', 'storefront' ); ?>">
	...
	function storefront_product_categories( $args ) {
		...
		if ( storefront_is_woocommerce_activated() ) {
			...
			$args = apply_filters( 'storefront_product_categories_args', array(
				...
				'child_categories' 	=> 0,
				'orderby' 			=> 'name',
				'title'				=> __( 'Dòng sản phẩm bán chạy', 'storefront' ),
			) );
	...
	function storefront_best_selling_products( $args ) {
		if ( storefront_is_woocommerce_activated() ) {
			...
			$args = apply_filters( 'storefront_best_selling_products_args', array(
				'limit'   => 4,
				'columns' => 4,
				'title'	  => esc_attr__( 'Sản phẩm bán chạy', 'storefront' ),
			) );
