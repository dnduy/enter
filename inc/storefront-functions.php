...
<div class="nav-collapse collapse">
            <ul class="nav">
              <li class="active">
                ...
                <a class="dropdown-toggle <?php if(is_shop()): echo "homecart-button"; endif;?>" data-toggle="dropdown" href="#">Danh Mục Sản Phẩm</a>
                 
                <ul class="dropdown-menu <?php if(is_shop()): echo "homecart"; endif;?>" role="menu">
            <?php
              $x = 0;
              $wcatTerms = get_terms('product_cat', array('hide_empty' => 0, 'orderby' => 'ASC',  'parent' =>0)); //, 'exclude' => '17,77'
              foreach($wcatTerms as $wcatTerm) :  $x++; ?>
                                    
                    <li data-submenu-id="submenu<?php echo $x;?>" class="sub-popover">
                        <a class="atop" href="<?php echo get_term_link( $wcatTerm->slug, $wcatTerm->taxonomy ); ?>"><?php echo $wcatTerm->name; ?>   </a>
                      
                        <div id="submenu<?php echo $x;?>" class="popover">
                            <h3 class="popover-title"><?php echo $wcatTerm->name; ?>   </h3>
                ...
                <?php   $wsubargs = array(
                    ...
                    foreach ($wsubcats as $wsc): ?>    
                                    <li class="lichildren"><a href="<?php echo get_term_link( $wsc->slug, $wsc->taxonomy );?>"><?php echo $wsc->name;?></a></li>
                    <?php endforeach; ?>  
                                 </ul>
    ...
    <script src="<?php bloginfo('template_directory'); ?>/js/menu/jquery-1.9.1.min.js" type="text/javascript"></script>
    <script src="<?php bloginfo('template_directory'); ?>/js/menu/jquery.menu-aim.js" type="text/javascript"></script>
    <script src="<?php bloginfo('template_directory'); ?>/js/menu/bootstrap.min.js" type="text/javascript"></script>
    <script>
 var $menu = $(".dropdown-menu");
        ...
        //    $(".popover-content").css('display','block');
         ...
         function exitMenus() {
                            $('.menu-toggle-product').mouseleave(function() {
                                $('.popover').css("display", "none");
                                $(".dropdown-menu a.atop").removeClass("maintainHover");
