		...
		if ( storefront_is_woocommerce_activated() ) { ?>
			<div class="site-search">
				<div class="company_info">
                                ...
                                <h1 title="" class="text-center brand-title">
                                ENTER LAPTOP                                 </h1>
				...
				<div class="address"> 
					<div class="col-md-6"><div class="text-info text-center"> Cơ sở 1: 51 Xuân Diệu, TP. Huế</div></div> 
					<div class="col-md-6"><div class="text-info text-center"> Cơ sở 2: 126 Phùng Hưng, TP. Huế</div></div> 
...
if(!function_exists('hotline_company')){
    /*
     * infomation company 
     */
    function hotline_company(){
        ?>  
                <div class="support-online">
                    <img style="float:left" src="<?php bloginfo('template_directory');?>/images/phone-call.gif" title="Camera gọi" alt="camera toàn gia phát">
                            <p class="ho-tro">Hỗ trợ trực tuyến 24/7</p>
                           
                            <p class="sdt">090.3588.177 <br> 0234.3588.177 </p> 
                </div>
        <?php
    }
}
...
function support_bar(){
    ?>
<div id="support-bar">
    <div class="left icons-support">
        <img src="<?php bloginfo('template_directory');?>/images/ho-tro-truc-tuyen-camera-minh-tan.gif" alt="" width="70"/>
    ...
    <div class="left social-support">
        <ul>
            <li>
               
                <div class="ihdiv2">
                                        <a href="skype:toangiaphatcn?chat" class="icons skype"><i class="fa fa-skype" aria-hidden="true"></i></a>
                </div>
                <p>Kỹ Thuật: 01</p>
                <!-- <p> <span class=""> 0905.535.979 </span></p> -->
              ...
              <li>
                ...
                <p>Kỹ Thuật: 02</p>
                <!-- <p> <span class=""> 0915.535.979  </span></p> -->
              ...
              <li>
                ...
                <p>Kỹ Thuật: 03</p>
                <!-- <p> <span class="">0905.010.313</span> -->
              ...
              <li>
                ...
                <p>Kinh doanh: </p>
                <!-- <p> <span class="">0915.943.535</span></p> -->
              ...
              <li>
                ...
                <div class="ihdiv2">
                  ...
                  <p>   Kế toán : &ensp;&ensp; </p>
                <!-- <p> <span class="">01238.535.979</span></p> -->
              ...
              <li>
                  ...
                  <div class="social">
                    <a href="https://www.facebook.com/cameratgp.hue/" class="link facebook" target="_parent"><span class="fa fa-facebook-square"></span></a>
...
add_action('storefront_header','support_bar',40);
